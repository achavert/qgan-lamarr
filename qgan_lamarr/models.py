...
class QGAN():
    '''
    Args:
        num_qubits: The number of qubits for the generator (and discriminator) circuits. Corresponds to log2(Nb), where Nb is the number of bins for the objective distribution.
            
        generator: The parametrized circuit used for the generator's QNN.
        
        discriminator: Either the parametrized circuit or a classical NN model for the discriminator.
        
        callback: A reference to a user's callback function that has two parameters (objective_weights, objective_value) and returns 'None'. The callback is 
